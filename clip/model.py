...
class Transformer(nn.Module):
    def __init__(self, width: int, layers: int, heads: int, attn_mask: torch.Tensor = None,
                 is_training=False, use_checkpoint=False):
        super().__init__()
        self.width = width
        self.layers = layers
...
class VisionTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, output_dim: int,
        ...
        self.transformer = Transformer(width, layers, heads, use_checkpoint=use_checkpoint, is_training=is_training)
...
def build_model(state_dict: dict, is_training =False, use_checkpoint=False):
    ...
    model = CLIP(
        ...
        is_training=is_training, use_checkpoint=use_checkpoint
