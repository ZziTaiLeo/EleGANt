...
DATASETS = {
	'ffhq_encode': {
		...
		'train_source_root': dataset_paths['my_data_train'],
		'train_target_root': dataset_paths['my_data_train'],
		'test_source_root': dataset_paths['my_data_test'],
		'test_target_root': dataset_paths['my_data_test'],
	},
	'cars_encode': {
