...
if __name__ == "__main__":
    ...
    # DATA
    parser.add_argument('--dataset_root', default='/media/pc/LabServers/hengda/datasets/MT-Dataset-bg-white/', type=str, help='root of your datasets')
    parser.add_argument('--dataset_json',default='/media/pc/LabServers/hengda/datasets/MT-Dataset-bg-white/all_mt_dataset.json',help='path/to/your_no_makeup/dataset.json')
    ...
    parser.add_argument('--source_latents',default='/media/pc/LabServers/hengda/datasets/latents/non-makeup/',help='path/to/your_no_makeup/dataset.json')
    parser.add_argument('--reference_latents',default='/media/pc/LabServers/hengda/datasets/latents/makeup/',help='path/to/your_no_makeup/dataset.json')
    #NET
    ...
    parser.add_argument('--cal_delta_loss', action='store_true',default=False,help='add delta loss')
